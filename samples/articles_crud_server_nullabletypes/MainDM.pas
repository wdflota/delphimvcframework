...
type
  TdmMain = class(TDataModule)
    ...
    dsArticlesSTATO: TSmallintField;
    dsArticlesDATADINASCITA: TDateField;
    dsArticlesTEMPODINASCITA: TTimeField;
    dsArticlesDATADICREAZIONE: TSQLTimeStampField;
...
begin
  ...
  // {$ELSE}
  lPath := 'data\ORDERSMANAGER_FB25NullTypes.FDB';
  for I := 1 to 6 do
  begin
