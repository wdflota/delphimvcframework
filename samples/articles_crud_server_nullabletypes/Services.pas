...
uses
  ...
  FireDAC.Comp.Client,
  FireDAC.Stan.Param,
  MVCFramework.FireDAC.Utils.NullableType,
...
//  Result := DataSetToObjectList<TArticle>(FDM.dsArticles);
...
//  AArticolo.CheckUpdate;
  ...
  TFireDACUtils.ObjectToParameters(Cmd.Params, AArticolo, 'NEW_', 'OLD_');
